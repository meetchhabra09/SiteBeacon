            ...
            <div className="group bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col">
                ...
                <div className="grid grid-cols-3 gap-2">
                    <button
                        ...
                        className="py-2.5 rounded-lg font-semibold text-white bg-purple-600 border-2 border-purple-600 hover:bg-purple-700 hover:border-purple-700 transition-all duration-200 flex items-center justify-center gap-1 text-sm"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        onClick={handleEdit}
                        className="py-2.5 rounded-lg font-semibold text-white bg-[#0073E6] border-2 border-[#0073E6] hover:bg-[#0066CC] hover:border-[#0066CC] transition-all duration-200 flex items-center justify-center gap-1 text-sm"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        ...
                        className="py-2.5 rounded-lg font-semibold text-gray-700 bg-white border-2 border-gray-200 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all duration-200 flex items-center justify-center gap-1 text-sm"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
